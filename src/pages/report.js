...
export function renderReport(data) {
  ...
  var mainContent =
    ...
    "</button></div>" +
    '<div class="rs-body">' +
    '<div class="rs-subtitle">Ask questions about ' +
    data.company +
    " grounded in structured research data</div>" +
    '<div class="chat-inline" data-ticker="' +
    data.ticker +
    '">' +
    '<div class="chat-inline-messages" id="chat-inline-' +
    data.ticker +
    '" aria-live="polite" aria-relevant="additions"></div>' +
    '<div class="chat-inline-input-area">' +
    '<textarea class="chat-inline-input" placeholder="Ask about ' +
    data.company +
    '..." rows="1" aria-label="Ask a question about ' +
    data.company +
    '"></textarea>' +
